...
for i = 1:m
    ...
    z3 = Theta2 * [1;a2];
    a3 = sigmoid(z3);
    J = J + sum(-Output.*log(a3)-(1-Output).*log(1-a3));
    delta3 = (a3 - Output);
...
Theta1_grad = Theta1_grad/m + [zeros(size(Theta1_grad,1),1) (lambda/m)*Theta1(:,2:end)];
Theta2_grad = Theta2_grad/m + [zeros(size(Theta2_grad,1),1) (lambda/m)*Theta2(:,2:end)];
